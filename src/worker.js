...
import { pulseBootCatchupFailureMessage, pulseBootCatchupMessage, queueMissedAgentPulse } from "./pulse-catchup.js";
...
if (!pulse.ready) {
  ...
  try {
    ...
    try {
      await notify(pulseBootCatchupFailureMessage(error));
    } catch {
      // Boot must continue even if Telegram is down.
    }
  }
