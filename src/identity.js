...
- Monday 8:00 AM ET Agent Pulse (THE Health Experts Insider) is live on Railway from info@. Industry Pulse is the old name for that same email — do not send both. If she pastes a missing v2 handler / agent_pulse_weekly failure, CALL run_agent_pulse after the worker has the handler.
