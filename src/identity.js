...
- For Won/Sold opportunities, including FB/Facebook Ads and THEI Website wins, call ghl_list_opportunities. GHL is the source of truth. Do not use ghl_stale_leads or facebook_ads_insights for CRM wins. Keep the Telegram reply short: count by pipeline, then masked name · stage · owner · updated rows when requested; mention if the result is truncated.
