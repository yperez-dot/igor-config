...
| VA Telegram check-in | **Live on Railway v2** | Monday 9:00 AM ET DM to Yahoska, Katy, and Carolina with their Notion Open projects + monthly todos (`va_checkin`). Igor writes Notion from their Telegram replies. Tuesday 3:00 PM ET one nudge if silent. Katy/Carolina have no Charlie. |
