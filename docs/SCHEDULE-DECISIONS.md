...
| SEP tracker health/process jobs | Keep and auto-publish | Monday HealthSpring scan may publish validated SEP updates automatically; require schema validation, pre-deploy snapshot, post-deploy health check, and Telegram success/failure alerts. |
